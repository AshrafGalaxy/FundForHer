    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <Tabs defaultValue="email" className="w-full" onValueChange={handleTabChange}>
          <TabsList className={`grid w-full mb-4 ${isProviderLogin ? 'grid-cols-1' : 'grid-cols-2'}`}>
            <TabsTrigger value="email"><Mail className="w-4 h-4 mr-2" /> Email</TabsTrigger>
            {!isProviderLogin && <TabsTrigger value="phone"><Phone className="w-4 h-4 mr-2" /> Phone</TabsTrigger>}
          </TabsList>
